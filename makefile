...
all:
	...
	./asmFish/fasm "asmFish/asmFishW_bmi1.asm"      -m 50000 "Windows/asmFishW_$(now)_bmi1.exe"
	...
	./asmFish/fasm "asmFish/asmFishL_bmi1.asm"      -m 50000 "Linux/asmFishL_$(now)_bmi1"
